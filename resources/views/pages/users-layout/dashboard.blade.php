    ...
    <div class=" mt-8 grid lg:grid-cols-2 sm:grid-cols-2 p-4 gap-10 mr-14 ml-14">
        ...
        <div class="bg-white flex rounded-2xl flex-col dark:bg-slate-900/70">
            <div class="flex-1 p-6 undefined">
                <div class="flex items-center justify-between mb-3">
                    <div
                        class="inline-flex items-center capitalize leading-none text-xs border rounded-full py-1 px-3 bg-teal-500 border-teal-500 text-white ">
                        <span class="inline-flex justify-center items-center w-4 h-4 mr-1">
                            <img src="{{ URL('img/arrow-right.png') }}" width="10" height="14" class="inline-block">
                            <path fill="currentColor" d="M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z">
                            </path>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span class="inline-flex justify-center items-center  h-16 text-teal-500">
                        <img src="{{ URL('img/protocols.png') }}" width="48" height="48" class="inline-block">
                        </img>
                    </span>
                </div>
            </div>
