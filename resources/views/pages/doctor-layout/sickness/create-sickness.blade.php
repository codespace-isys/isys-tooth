...
@section('content')
    <div class="w-full container md:mx:auto mt-20 overflow-x-auto">
        <div class="bg-white rounded-lg shadow-lg p-5 ">
            ...
            <form action="{{ route('store-sickness') }}" method="POST" enctype="multipart/form-data" class="w-full max-w-screen-2xl mt-10">
                @csrf
                ...
                <label for="countries" class="block mb-2 mt-5 text-sm font-medium text-gray-900 dark:text-white">Select an
                    option</label>
