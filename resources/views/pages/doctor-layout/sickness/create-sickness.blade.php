    ...
    <div class="container w-full md:w-11/12 xl:w-11/12 md:h-11/12 mx-auto px-2 mb-10 mt-10 shadow-2xl ">
        <div class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            ...
            <form action="{{ route('store-sickness') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="relative flex items-center text-gray-400 focus-within:text-gray-600">
                    ...
                    @if (!$errors->has('sickness_code'))
                        <img src="{{ URL('img/virus_code.png') }}" alt=""
                            class="w-5 h-5 absolute ml-3 pointer-events-none">
                    @endif
                    <input type="text" name="sickness_code" placeholder="Input Sickness Code" autocomplete="off"
                        aria-label="Input Table" value="{{ $sickness_code }}" readonly
                ...
                <div class="relative flex items-center text-gray-400 focus-within:text-gray-600">
                    ...
                    @if (!$errors->has('sickness_name'))
                        <img src="{{ URL('img/virus.png') }}" alt=""
                            class="w-5 h-5 absolute ml-3 pointer-events-none">
                    @endif
                    <input type="text" name="sickness_name" placeholder="Input Sickness Name" autocomplete="off"
                        aria-label="Input Table" value="{{ old('sickness_name') }}"
                ...
                @enderror
                <label for="large-input"
                    class="block mb-2 text-xl font-medium text-gray-900 dark:text-white mt-5{{ $errors->has('medicine_id') ? 'block text-sm font-medium text-red-700 dark:text-red-500' : '' }} ">Medicine
                    Name</label>
                <div class="flex ">
                    <div id="states-button" data-dropdown-toggle="dropdown-states"
                        class="flex-shrink-0 z-10 inline-flex items-center py-1 px-4 text-sm font-medium text-center text-gray-500 bg-gray-100 border border-gray-300 rounded-l-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600{{ $errors->has('medicine_id') ? 'flex-shrink-0 z-10 inline-flex items-center py-1 px-4 text-sm font-medium text-center text-red-500 bg-red-100 border border-red-300 rounded-l-lg hover:bg-red-200 focus:ring-4 focus:outline-none focus:ring-red-100 dark:bg-red-700 dark:hover:bg-red-600 dark:focus:ring-red-700 dark:text-white dark:border-red-600' : '' }}"
                        type="button">
