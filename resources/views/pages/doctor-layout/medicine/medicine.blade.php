                ...
                @foreach ($medicines as $medicine)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="#" type="button" {{-- href="{$medicine->id}}" --}}
                                ...
                                <div class="relative w-full h-full max-w-md md:h-auto">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="px-6 py-6 lg:px-8">
                                            <h3 class="mb-4 text-xl font-semibold text-left text-gray-900 dark:text-white">Edit Data Medicine</h3>
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="text" name="medicine_information"
                                                            placeholder="Input Medicine Information" autocomplete="off"
