            ...
            <form action="" method="POST" enctype="multipart/form-data" class="w-full max-w-screen-2xl mt-10">
                ...
                <div class="relative flex items-center text-gray-400 focus-within:text-gray-600">
                    ...
                    <input type="text" name="title" placeholder="Input Title" autocomplete="off"
                        aria-label="Input Table" value="{{ old('title') }}"
                ...
                <textarea name="description" id="myTextarea" cols="30" rows="10">{{ old('description') }}</textarea>
                @error('description')
                ...
                <input
                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400{{ $errors->has('image') ? 'block w-full text-sm text-red-900 border border-red-300 rounded-lg cursor-pointer bg-red-50 dark:text-red-400 focus:outline-none dark:bg-red-700 dark:border-red-600 dark:placeholder-red-400' : '' }}"
