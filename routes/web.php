...
Route::group(['middleware' => ['is_admin']], function () {
    ...
    Route::get('/pages/users-layout/report-articles', 'Admin\AdminArticles@report_articles')->name('report-articles');
...
Route::group(['middleware' => ['is_doctor']], function () {
    ...
    Route::get('/pages/doctor-layout/report-medicine', 'Doctor\DoctorMedicines@report_medicine')->name('report-medicine');
    ...
    Route::get('/pages/doctor-layout/report-indication', 'Doctor\DoctorIndication@report_indication')->name('report-indication');
    ...
    Route::get('/pages/doctor-layout/report-sickness', 'Doctor\DoctorSickness@report_sickness')->name('report-sickness');
});
